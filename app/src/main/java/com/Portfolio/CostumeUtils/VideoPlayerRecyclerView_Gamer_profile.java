...
public class VideoPlayerRecyclerView_Gamer_profile extends RecyclerView {
    ...
    private boolean IsInsideNestedScroll = false;
    // controlling playback state
    private VolumeState volumeState;

    public VideoPlayerRecyclerView_Gamer_profile(@NonNull Context context) {
        super(context);
        init(context);
    }

    public VideoPlayerRecyclerView_Gamer_profile(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public void TogleScroolview(boolean IsInScrollView) {
        IsInsideNestedScroll = IsInScrollView;
    }
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        PostRecyclerview.MyViewHolder holder = (PostRecyclerview.MyViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
